...
var init = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                log_1.logger.info('Connecting database...');
                return [4 /*yield*/, dataBase_1.connect()];
            case 1:
                _a.sent();
                log_1.logger.info("Started on " + labels_1.CONST.APP_PORT);
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
                log_1.logger.error('Exiting...');
                process.exit(1);
                return [3 /*break*/, 3];
...
init();
exports.server = app.listen(labels_1.CONST.APP_PORT);
